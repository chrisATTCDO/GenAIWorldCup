...
profile = {
  ...
  'trailingPE': get_value(ticker.info, 'trailingPE'),
  'forwardPE': get_value(ticker.info, 'forwardPE'),
  ...
  'priceToBook': get_value(ticker.info, 'priceToBook'),
  ...
  'earningsQuarterlyGrowth': get_value(ticker.info, 'earningsQuarterlyGrowth'),
  ...
  'lastSplitFactor': get_value(ticker.info, 'lastSplitFactor'),
  'lastSplitDate': epoch_to_date(get_value(ticker.info, 'lastSplitDate')),
