...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-science&org_id=2754134964726624&notebook=%2F00-AI-function-tools-introduction&demo_name=llm-tools-functions&event=VIEW&path=%2F_dbdemos%2Fdata-science%2Fllm-tools-functions%2F00-AI-function-tools-introduction&version=1">

# COMMAND ----------

# MAGIC %md 
# MAGIC ### A cluster has been created for this demo
# MAGIC To run this demo, just select the cluster `dbdemos-llm-tools-functions-cv0361` from the dropdown menu ([open cluster configuration](https://adb-2754134964726624.4.azuredatabricks.net/#setting/clusters/1015-010515-p91lljxm/configuration)). <br />
# MAGIC *Note: If the cluster was deleted after 30 days, you can re-create it with `dbdemos.create_cluster('llm-tools-functions')` or re-install the demo: `dbdemos.install('llm-tools-functions')`*
